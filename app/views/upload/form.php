...
$maxTotalSize = getenv('MAX_UPLOAD_SIZE') ?: 10 * 1024 * 1024 * 1024; // 10 Go
$maxFileSize = getenv('MAX_SIZE_PER_TRANSFER') ?: 2 * 1024 * 1024 * 1024; // 2 Go
?>
...
<main class="flex-grow flex items-center justify-center p-4">
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-2xl">
        ...
        <h1 class="sr-only">Formulaire d'envoi de fichiers - BognyTransfert</h1>
        <h2 class="text-2xl font-bold mb-6 text-center">Envoyer un ou plusieurs fichiers</h2>
        ...
        >
            ...
            <div>
                <label for="encryption_level" class="block font-semibold mb-1">Sécurité des fichiers :</label>
            ...
            <div id="drop-zone" class="w-full border-4 border-dashed border-gray-300 rounded-xl p-6 text-center transition hover:bg-gray-50 cursor-pointer">
                ...
                <button type="button" id="add-more-files" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition hidden">
            ...
            <div class="text-center">
                <button type="submit" id="submitButton" class="bg-blue-600 text-white px-6 py-2 rounded-full transition disabled:opacity-50 disabled:cursor-not-allowed hover:bg-blue-700" disabled>
                    Envoyer
                </button>
            </div>
        </form>
