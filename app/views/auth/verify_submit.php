...
<head>
    <meta charset="UTF-8">
    <title>Vérification 2FA - BognyTransfert</title>
...
<main class="flex-grow flex items-center justify-center p-4">
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        <h1 class="text-2xl font-bold mb-6 text-center">Vérification du code</h1>
        ...
        <form action="/verify/submit" method="post" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="code" name="code" required maxlength="10"
                       placeholder="Entrez le code reçu par email ou via l'application"
