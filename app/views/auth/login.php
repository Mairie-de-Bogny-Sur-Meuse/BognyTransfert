...
<head>
    <meta charset="UTF-8">
    <title>Connexion - BognyTransfert</title>
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <form action="/login/submit" method="post" class="space-y-4">
            ...
            <div class="flex justify-between text-sm text-blue-600 mt-2">
                <a href="/forgot" class="hover:underline">Mot de passe oublié ?</a>
                <a href="/register" class="hover:underline">Créer un compte</a>
            </div>
